    ...
    <section className="bg_blue py-5">
      <div className="my_container">
        <Row className="d-flex flex-lg-row">
          <Col lg={8}>
            <Row>
              <Col sm={4} className="" data-aos="zoom-in-right">
                <span className="d-flex align-items-center justify-content-start pointer">
                  <svg
                    width="40"
                    height="40"
                    viewBox="0 0 40 40"
              ...
              <Col sm={4} data-aos="zoom-in-right">
                <ul className="ps-0 mt-5 mt-sm-4 mt-xl-0">
                  <li>
                    <p className="fw_500 ff_rubic fs_lg clr_white">
                      Quick Link
                    </p>
                  </li>
                  <li className="pt-xl-3">
                    <a
                      className="fw_400 ff_rubic fs_sm text-start clr_light_grey position-relative hover_line"
                      href="#"
                    >
                      Home
                    </a>
                  ...
                  <li className="pt-3">
                    <a
                      className="fw_400 ff_rubic fs_sm clr_light_grey position-relative hover_line"
                      href="#"
                    >
                      Products
                    </a>
          ...
          <Col
            lg={4}
            className="d-flex flex-column  mt-4 mt-xl-0 text-lg-center text-start"
            data-aos="zoom-in-right"
          >
            <p className="fw_500 mb-4 ff_rubic text-start fs_2xl clr_white">
        ...
        <div
          className="d-flex flex-column flex-sm-row justify-content-between pt-4 pt-xl-5 mt-xl-5 text-lg-center text-start align-items-center align-items-sm-start"
          data-aos="flip-down"
          data-aos-duration="3000"
        >
          <p className="fw_400 ff_rubic fs_sm clr_white">
